...
I run this code using an image from my country, Paraguay, as you can see from the images. 

![l8_zoom_out](https://github.com/neli12/screenshots-figures/blob/main/l8_zoom_out.PNG)
